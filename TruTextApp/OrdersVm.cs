...
namespace TruTextApp
{
    ...
    {
        private List<OrdersCl> recordList;  /*****/
        ...
        private void Add()
        {
            OrdersCl newRecord = new OrdersCl { OrderID = 0 };  /*****2*/
        ...
        private async void SaveAsync()
        {
            ...
            if (this.ValidateRecord(this.Current))
            {
                ...
                try
                {
                    ...
                    if (this.IsAdding)
                    {
                        ...
                        if (response.IsSuccessStatusCode)
                        {
                            ...
                            if (newRecord.IsSuccessStatusCode)
                            {
                                ...
                                this.CopyRecord(
                                    JsonConvert.DeserializeObject<OrdersCl>(recordData), this.Current);  /*****/
                                this.OnPropertyChanged(nameof(Current));
                                this.IsAdding = false;
                                this.IsBrowsing = true;
                                this.LastError = String.Empty;
                    ...
                    {
                        string path = $"api/Orders/{this.Current.OrderID}";  /*****2*/
        ...
        public async Task GetDataAsync()
        {
            try
            {
                ...
                if (response.IsSuccessStatusCode)
                {
                    ...
                    this.recordList = JsonConvert.DeserializeObject<List<OrdersCl>>(recordData);  /*****/
