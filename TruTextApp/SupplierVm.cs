...
namespace TruTextApp
{
    ...
    {
        private List<SupplierCl> recordList;
        ...
        private void Add()
        {
            SupplierCl newRecord = new SupplierCl { SupID = 0 };
        ...
        private async void SaveAsync()
        {
            ...
            if (this.ValidateRecord(this.Current))
            {
                ...
                try
                {
                    ...
                    {
                        var response =
                            await client.PostAsync("api/Suppliers", content);
                        if (response.IsSuccessStatusCode)
                        {
                            ...
                            if (newRecord.IsSuccessStatusCode)
                            {
                                ...
                                this.CopyRecord(
                                    JsonConvert.DeserializeObject<SupplierCl>(recordData), this.Current);
                                this.OnPropertyChanged(nameof(Current));
                                this.IsAdding = false;
                                this.IsBrowsing = true;
                                this.LastError = String.Empty;
                    ...
                    {
                        string path = $"api/Suppliers/{this.Current.SupID.ToString()}";
        ...
        public async Task GetDataAsync()
        {
            try
            {
                ...
                if (response.IsSuccessStatusCode)
                {
                    ...
                    this.recordList = JsonConvert.DeserializeObject<List<SupplierCl>>(recordData);
