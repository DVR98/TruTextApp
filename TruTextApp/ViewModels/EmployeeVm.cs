...
namespace TruTextApp
{
    ...
    {
        private List<EmployeeCl> recordList;  /*****/
        ...
        private void Add()
        {
            EmployeeCl newRecord = new EmployeeCl { EmpID = 0 };  /*****2*/
        ...
        private async void SaveAsync()
        {
            ...
            if (this.ValidateRecord(this.Current))
            {
                ...
                try
                {
                    ...
                    if (this.IsAdding)
                    {
                        ...
                        if (response.IsSuccessStatusCode)
                        {
                            ...
                            if (newRecord.IsSuccessStatusCode)
                            {
                                ...
                                this.CopyRecord(
                                    JsonConvert.DeserializeObject<EmployeeCl>(recordData), this.Current);  /*****/
                                this.OnPropertyChanged(nameof(Current));
                                this.IsAdding = false;
                                this.IsBrowsing = true;
                                this.LastError = String.Empty;
                    ...
                    {
                        string path = $"api/employees/{this.Current.EmpID}";  /*****2*/
        ...
        public async Task GetDataAsync()
        {
            try
            {
                ...
                if (response.IsSuccessStatusCode)
                {
                    ...
                    this.recordList = JsonConvert.DeserializeObject<List<EmployeeCl>>(recordData);  /*****/
